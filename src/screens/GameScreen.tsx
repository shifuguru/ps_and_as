...
function GameScreen({
  ...
  const onTrickPauseClosingPlayLanded = useCallback((playKey: string) => {
...
function GameScreenBoard() {
  ...
  const onTrickPauseClosingPlayLanded =
    (runtimeCtx?.onTrickPauseClosingPlayLanded as
      | ((playKey: string) => void)
      | undefined) ?? (() => {});
  ...
  const handlePlayFlightLanded = useCallback(
    (playKey: string) => {
      ...
      onTrickPauseClosingPlayLanded(playKey);
    },
    [
