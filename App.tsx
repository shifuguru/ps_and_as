    ...
    <View style={{ flex: 1 }}>
        ...
        {menuVisible && screen === "menu" && (
          <Animated.View style={[styles.menuContainer, { opacity: menuOpacity }]}>
            <Text style={[styles.title, { fontSize: 42, fontWeight: '300', letterSpacing: -1, marginTop: 120 }]}>P's & A's</Text>
            ...
            <View style={styles.buttonGroup}>
              ...
              >
                <View style={menuTiers.row}>
                  <MenuIcon name="plus" size={20} color="#0a0a0a" />
              ...
              <View style={menuTiers.secondaryRow}>
                ...
                >
                  <View style={menuTiers.row}>
                    <MenuIcon name="globe" size={16} color="rgba(255,255,255,0.6)" />
                ...
                >
                  <View style={menuTiers.row}>
                    <MenuIcon name="shuffle" size={16} color="rgba(255,255,255,0.6)" />
              ...
              <View style={menuTiers.utilityRow}>
                <TouchableOpacity
                  ...
                  onPress={() => { playEffect("click"); setScreen("create"); }}
                >
                  <MenuIcon name="person" size={18} color="rgba(255,255,255,0.35)" />
                ...
                >
                  <MenuIcon name="trophy" size={18} color="rgba(255,255,255,0.35)" />
                ...
                >
                  <MenuIcon name="gear" size={18} color="rgba(255,255,255,0.35)" />
